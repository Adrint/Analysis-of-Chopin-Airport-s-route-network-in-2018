...
# Funkcja do konwersji czasu epoch 
...
# Odszukanie wszystkich dokumentów 
...
with codecs.open('origin_chopin.json', 'w', encoding='utf-8') as file:
...
with codecs.open('origin_chopin.json', 'r', encoding='utf-8') as file:
    for line in file:
        line = line.strip()
        if line:
            print(line)
